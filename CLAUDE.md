...
- **DB:** PostgreSQL · **ORM:** Drizzle (`drizzle-orm/postgres-js`; config in `app/drizzle.config.ts`, schema barrel in `src/infrastructure/database/schema/`)
